...
_VIBRATIONPATTERN.fields_by_name['header'].message_type = base_msgs_pb2._HEADER
...
class VibrationPattern(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
